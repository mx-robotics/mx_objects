#ifndef MX_OBJECTS_ACKERMANNCOMMAND_H
#define MX_OBJECTS_ACKERMANNCOMMAND_H
...
public:
    ...
    AckermannCommand (const AckermannCommand &o)
        : coubled{o.coubled[LEFT], o.coubled[RIGHT]}
        , v{o.v[LEFT], o.v[RIGHT]}
        , steering(o.steering) 
        , mode(o.mode) {};

    AckermannCommand (float v_left, float v_right, float steering, uint16_t mode, bool coubled = true)
    ...
    friend std::ostream &operator << ( std::ostream &os, const AckermannCommand &o ) {
        os << o.getToString();
        return os;
    };
...
#endif // MX_OBJECTS_ACKERMANNCOMMAND_H
